...
catalog-proto:
	@cd catalog/proto && protoc --micro_out=. --go_out=. catalog.proto
warehouse-proto:
	@cd warehouse/proto && protoc --micro_out=. --go_out=. warehouse.proto
shipping-proto:
	@cd shipping/proto && protoc --micro_out=. --go_out=. shipping.proto
